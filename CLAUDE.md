...
This project is indexed by GitNexus as **gitnexus-multiverse** (16878 symbols, 21785 relationships, 188 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/gitnexus-multiverse/context` | Codebase overview, check index freshness |
| `gitnexus://repo/gitnexus-multiverse/clusters` | All functional areas |
| `gitnexus://repo/gitnexus-multiverse/processes` | All execution flows |
| `gitnexus://repo/gitnexus-multiverse/process/{name}` | Step-by-step execution trace |
