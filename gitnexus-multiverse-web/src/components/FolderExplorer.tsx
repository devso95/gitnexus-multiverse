    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60">
      <div className="border-border w-[500px] rounded-xl border bg-surface p-6 shadow-2xl">
            ...
            <div className="flex flex-col">
              {parentPath !== null && (
                <button
                  ...
                  className="hover:bg-accent/10 border-border border-b px-4 py-2 text-left text-sm text-white"
                >
              ...
              {directories.map((d) => (
                <button
                  ...
                  className="hover:bg-accent/10 border-border flex items-center border-b px-4 py-2 text-left text-sm text-white"
                >
                  ...
                  <div 
                    ...
                    className="text-accent hover:bg-accent hover:text-white rounded px-2 py-0.5 text-xs font-medium"
                  >
                    Select
                  </div>
                </button>
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button
            onClick={onClose}
            className="bg-surface2 border-border text-text flex-1 rounded-lg border py-2 text-sm hover:bg-surface3"
          >
            Cancel
          </button>
        </div>
